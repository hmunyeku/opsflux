"""
OpsFlux - Configuration Django de Base
...
DATABASES = {
    'default': dj_database_url.config(
        default=os.environ.get('DATABASE_URL', 'postgresql://opsflux_user:password@postgres:5432/opsflux'),
        conn_max_age=600,
...
STATICFILES_DIRS = []  # Pas de répertoire static personnalisé pour éviter les warnings
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'OpsFlux API',
    'DESCRIPTION': 'API REST pour OpsFlux - ERP Modulaire Intelligent',
    'VERSION': '1.0.0',
...
# Configuration spécifique OpsFlux
OPSFLUX_CONFIG = {
    'VERSION': '1.0.0',
    'COMPANY_NAME': 'OpsFlux',
    'SUPPORT_EMAIL': 'support@opsflux.io',
